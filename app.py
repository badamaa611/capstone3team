...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///super_brain.db'
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False

# 2. Өгөгдлийн сан болон Логин менежер бэлдэх
db = SQLAlchemy(app)
login_manager = LoginManager(app)
login_manager.login_view = 'auth.login'  # Хэрэв нэвтрээгүй бол auth.login руу шилжүүлнэ
login_manager.login_message_category = 'info'

# 3. Өгөгдлийн сангийн Модел (User Table)
...
# 4. Blueprint-ийг импортлож бүртгэх (Энэ маш чухал, auth.login-ийг ажиллуулна)
...
if __name__ == '__main__':
    with app.app_context():
        db.create_all()  # Өгөгдлийн санг автоматаар үүсгэх
    app.run(debug=True)